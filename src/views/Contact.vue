<template>
  <div>
    ...
    <div style="margin-bottom:40px;">Feel free to contact me about any opportunity, or just to chat about cooking, kittens or anything else.</div>

    <ul>
      <li>
        <i class="fa fa-envelope-o fa-lg fa-fw"></i>
        <a href="gustavoncbarros@gmail.com" target="_blank">gustavoncbarros@gmail.com</a>
      </li>
      <li>
        <i class="fa fa-linkedin fa-lg fa-fw" style="vertical-align: -5%;"></i>
        <a href="https://www.linkedin.com/in/gustavoncbarros/" target="_blank">linkedin.com/gustavoncbarros</a>
      </li>
      <li>
        <i class="fa fa-github fa-lg fa-fw"></i>
        <a href="https://github.com/gustavoncbarros" target="_blank">github.com/gustavoncbarros</a>
      </li>
      <!-- <li>
